...
useEffect(()=>{
    ...
    ?
    setDataIsReady(prev=>({...prev, allDataIsReady: true}))
    :
    setDataIsReady(prev=>({...prev, allDataIsReady: false}))
},[dataIsReady])
...
const registerF = ()=>{
  ...
  return (
    ...
    <label htmlFor="user-name" className='w-full p-3 py-1 m-3 mb-1 rounded-lg flex items-center justify-center transition-all shadow shadow-slate-400 cursor-pointer  '>
      <span className='w-2/5 text-right mr-3'>User Name:</span>
    ...
    <p className={!dataIsReady.userNameIsReady ? 'w-full p-3 py-1 mb-3 rounded-lg   text-red-400 text-center  ': 'hidden'}>Minimum 5 simvol, Herfle baslamalidi</p>
   ...
   <label htmlFor="password" className='w-full p-3 py-1 m-3 rounded-lg flex items-center justify-center transition-all shadow shadow-slate-400 cursor-pointer  '>
    <span className='w-2/5 text-right mr-3'>Password:</span>
   ...
   <p className={!dataIsReady.passwordIsReady ? 'w-full p-3 py-1 mb-3  text-center  text-red-400   ': 'hidden'}>Minimum 8 simvol, Boyukherf, kicik herf, reqem, !@#$%&*</p>
   ...
   <label htmlFor="confirm-password" className='w-full p-3 py-1 m-3 rounded-lg flex items-center justify-center transition-all shadow shadow-slate-400 cursor-pointer  '>
    <span className='w-2/5 text-right mr-3'>Password Confirm:</span>
   ...
   <p className={!dataIsReady.confirmPasswordIsReady ? 'w-full p-3 py-1 mb-3  text-center  text-red-400   ': 'hidden'}>Parollar eyni olmalidi</p>
    
   <input type="submit" value="SignUp" className={dataIsReady.allDataIsReady? 'w-full px-3 py-1 m-3 rounded-lg flex items-center justify-center transition-all shadow shadow-slate-400  hover:scale-95 hover:shadow-none cursor-pointer': 'w-full px-3 py-1 m-3 rounded-lg flex items-center justify-center transition-all shadow shadow-slate-400 cursor-not-allowed'} disabled = {!dataIsReady.userNameIsReady || !dataIsReady.passwordIsReady || !dataIsReady.confirmPasswordIsReady ? true:false }/>
